...
<div class="space-y-5">
    <div class="bg-white rounded-xl border border-slate-200 p-5">
        <h1 class="text-2xl font-bold text-slate-900">মাসিক রিপোর্ট</h1>
        <form method="GET" class="mt-4 flex gap-3 items-center">
            <input type="month" name="month" value="{{ $year }}-{{ str_pad($month, 2, '0', STR_PAD_LEFT) }}" class="border rounded-lg px-3 py-2">
